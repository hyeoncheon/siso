...
=== Install and Setup bootstrap
 ...
 $ sed -i "/uglifier/a\  gem 'less-rails'" Gemfile
 $ sed -i "/less-rails/a\  gem 'twitter-bootstrap-rails'," Gemfile
 $ sed -i "/bootstrap/a\    :git => 'git://github.com/seyhunak/twitter-bootstrap-rails.git'" Gemfile
 $ bundle install --path=$HOME/.gem
 $ rails generate bootstrap:install less
      ...
      create  app/assets/stylesheets/bootstrap_and_overrides.css.less
        ...
        gsub  app/assets/stylesheets/application.css
 $ rails g bootstrap:layout bootstrapped
      create  app/views/layouts/bootstrapped.html.erb

now, new layout bootstrapped can be used on view.
